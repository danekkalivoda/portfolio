<template>
  <Layout>
    <div class="flex flex-col w-full max-w-6xl mx-auto">
      <div class="px-8 pt-16 pb-4 sm:pt-32 sm:pb-10 md:pr-16 md:pl-32 flex flex-col items-center justify-center w-full xl:m-auto text-center transition-all">
      ...
      <div class="w-full max-w-6xl overflow-hidden sm:overflow-visible">
        <div class="-mx-2 flex flex-wrap">
          <projects v-for="(project, index) in $page.projects.result" :key="project.name" :project="project" :index="index" headers="h2"/>
        </div>
        <!-- <pagination-posts
